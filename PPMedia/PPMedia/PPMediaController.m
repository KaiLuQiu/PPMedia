...
@interface PPMediaController ()<OnPreparedListener, OnCompletionListener, OnSeekCompletionListener, OnErrorListener, OnInfoListener> {
    PPMediaMidlle               *_player;
...
- (void)viewDidLoad {
    ...
    _player = [[PPMediaMidlle alloc] initPlayer:[path UTF8String]];
...
#pragma mark PPMedia PROTOCOL
#pragma mark - OnPreparedListener
-(void) onPrepared {
    printf("PPMedia: Prepared !!!\n");
}
